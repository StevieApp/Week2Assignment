...
void main() {
  ...
  print("Subtraction is ${addTwo(3,2)}");
  print("Multiplication is ${addTwo(3,2)}");
  print("Division is ${addTwo(3,2)}");
  print("Length of string is ${stringLength("Hello world!")}");
  print("First element is ${getFirstElement(["Dog", 1, "Cat", "20", "Elephant"])}");
}
